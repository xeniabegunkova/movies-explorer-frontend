    ...
    <section className="auth">
      <div className="auth__greetings">
        <Link to="/" className="auth__link">
          <img src={logo} alt="auth img" className="auth__img" />
        </Link>
      ...
      <form className="auth__form" onSubmit={handleSubmit}>
        ...
        {nameDirty && nameError && (
          <div className="auth__input-error">{nameError}</div>
        )}
        ...
        {emailDirty && emailError && (
          <div className="auth__input-error">{emailError}</div>
        )}
        ...
        {passwordDirty && passwordError && (
          <div className="auth__input-error">{passwordError}</div>
        )}
